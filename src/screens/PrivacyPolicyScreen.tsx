        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <ScrollView keyboardShouldPersistTaps="handled" style={{ backgroundColor: theme.auth.background }}>
            <View style={[Layout.container, {alignItems: 'center'}]}>
                ...
                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center" }]}>Information We Collect:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                    - Full name{"\n"}
                    - Email address{"\n"}
                ...
                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center" }]}>What We Do NOT Collect:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                ...
                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center" }]}>Data Security:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                ...
                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center" }]}>Your Rights:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                    You may view, update, or delete your data by contacting: alexandros.kazalis@gmail.com
                </Text>

                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center" }]}>GDPR Rights:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                    EU users retain rights to access, correct, delete or export their data. Most actions can be performed directly in the app.
                </Text>

                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center" }]}>Data Retention:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                    Your data is stored until you delete your account. Journal entries can be deleted at any time.
                </Text>

                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center"  }]}>Children’s Privacy:</Text>
                <Text style={[Typography.body, { color: theme.auth.text}]}>
                    We do not knowingly collect data from children under 13. Parental supervision is recommended for young users.
                </Text>

                <Text style={[Typography.title, { marginTop: 20, color: theme.auth.text, textAlign: "center"  }]}>Changes to This Policy:</Text>
                <Text style={[Typography.body, { color: theme.auth.text }]}>
