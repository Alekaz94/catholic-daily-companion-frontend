        ...
        <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
            <View style={[Layout.container, { backgroundColor: "rgba(0,0,0,0.6)", justifyContent: "center", alignItems: "center" }]}>
                <View style={{ backgroundColor: theme.auth.background, padding: 20, borderRadius: 10, width: "90%" }}>
                    ...
                    {journals && journals.length > 0 && (
                        <View>
                            {journals.map((journal) => (
                                <TouchableOpacity 
                                    key={journal.id}
                                    style={[Layout.card, {backgroundColor: theme.journal.primary, marginBottom: 6, borderRadius: 14}]}
                                    onPress={() => {
                    ...
                    {rosary && (
                        <View style={[Layout.card, {backgroundColor: theme.prayer.primary, marginBottom: 6, borderRadius: 14}]}>
